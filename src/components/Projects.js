  ...
  return (
      <>
        <div className="projects-container">
          <ProjectCard
              src = {`${process.env.PUBLIC_URL}/images/logobeer.png`}
              name = "BeerCalc"
          ...
          />
          <ProjectCard
              src = {`${process.env.PUBLIC_URL}/images/logome.png`}
              name = "My Portfolio"
              text = "Website you are currently on, created with React."
              linkToSource = "https://github.com/juliapedrycz/portfolio"
          />
          <ProjectCard
              src = {`${process.env.PUBLIC_URL}/images/logoasia.png`}
